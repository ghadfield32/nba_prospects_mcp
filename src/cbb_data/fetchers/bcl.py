...
def fetch_schedule(season: str = "2023-24") -> pd.DataFrame:
    ...
    **HTML-FIRST APPROACH**: Scrapes championsleague.basketball website to
    automatically discover game IDs and build schedule. Falls back to pre-built
    CSV game index if HTML scraping fails.

    This eliminates the need for manual game ID collection in most cases.
    ...
    Note:
        ...
        - Returns empty DataFrame if both methods fail
    """
