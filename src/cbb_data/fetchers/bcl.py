...
Official Basketball Champions League data via FIBA LiveStats HTML scraping.
...
- Box scores: https://fibalivestats.dcd.shared.geniussports.com/u/BCL/[GAME_ID]/bs.html
- Play-by-play: https://fibalivestats.dcd.shared.geniussports.com/u/BCL/[GAME_ID]/pbp.html
...
def fetch_shot_chart(
    ...
    """Fetch BCL shot chart data for a season
