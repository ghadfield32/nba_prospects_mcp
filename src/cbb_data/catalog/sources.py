...
def _register_league_sources() -> None:
    ...
    **Phase 3 Plan**:
    ...
    # LNB Pro A (France) - Full Integration Complete (7/7 datasets)
    register_league_source(
        LeagueSourceConfig(
            league="LNB_PROA",
            ...
            notes="COMPLETE: LNB Pro A is the only international league with 7/7 datasets functional. API-based schedule/season stats + normalized parquet box scores (2021-2025) + historical PBP/shots (2025-2026).",
        )
    )
