...
class TestSingleDateFiltering:
    ...
    def test_single_date_string_format(self):
        ...
        if not df.empty:
            ...
            game_dates = df['GAME_DATE'].dt.date if hasattr(df['GAME_DATE'], 'dt') else df['GAME_DATE']
    ...
    def test_single_date_datetime_object(self):
...
class TestDateRangeFiltering:
    ...
    def test_date_range_basic(self):
        ...
        if not df.empty:
            ...
            assert all(start <= d <= end for d in game_dates if d is not None), \
    ...
    def test_start_date_only(self):
        ...
        if not df.empty:
            ...
            assert all(d >= start for d in game_dates if d is not None), \
    ...
    def test_end_date_only(self):
        ...
        if not df.empty:
            ...
            assert all(d <= end for d in game_dates if d is not None), \
...
class TestDateFilterCombinations:
    ...
    def test_date_and_team_filter(self):
        ...
        if not df.empty:
            ...
            assert 'HOME_TEAM' in df.columns or 'AWAY_TEAM' in df.columns, \
    ...
    def test_date_and_granularity_filter(self):
...
class TestEuroLeagueDateFiltering:
    ...
    def test_euroleague_date_filter(self):
    ...
    def test_euroleague_single_date(self):
...
class TestDateFilterDataQuality:
    ...
    def test_date_filter_preserves_data(self):
...
class TestDateFilterEdgeCases:
    ...
    def test_date_and_date_range_conflict(self):
