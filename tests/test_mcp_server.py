...
class TestMCPTools:
    ...
    def test_tool_list_datasets(self):
    ...
    def test_tool_get_schedule(self):
    ...
    def test_tool_get_player_game_stats(self):
    ...
    def test_tool_get_player_season_stats(self):
    ...
    def test_tool_get_recent_games(self):
        """Test get_recent_games tool."""
        result = tool_get_recent_games(
            league="NCAA-MBB",
            days=2
        )
    ...
    def test_tool_with_invalid_league(self):
...
class TestMCPResources:
    ...
    def test_resources_registry_structure(self):
    ...
    def test_static_resources_structure(self):
    ...
    def test_resource_list_datasets(self):
    ...
    def test_resource_get_dataset_info(self):
    ...
    def test_resource_get_dataset_info_nonexistent(self):
    ...
    def test_resource_get_league_info(self):
    ...
    def test_resource_get_league_info_invalid(self):
...
class TestMCPPrompts:
    ...
    def test_prompts_registry_structure(self):
    ...
    def test_prompt_argument_types(self):
...
class TestMCPIntegration:
    ...
    def test_tool_execution_returns_formatted_data(self):
    ...
    def test_resources_cover_all_datasets(self):
    ...
    def test_prompts_reference_valid_tools(self):
        ...
        for prompt in PROMPTS:
            ...
            has_tool_reference = any(
                tool_name in template for tool_name in tool_names
            )

            # This is a soft check - not all prompts need to mention tools explicitly
            # but most should
            if "Use the" in template or "tool" in template.lower():
                assert has_tool_reference, f"Prompt '{prompt['name']}' mentions tools but doesn't reference valid ones"
